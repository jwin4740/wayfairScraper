...
const sizeElement = '.ProductDetail-select-category[data-category="Size"]';
...
module.exports = {
    ...
    PricingAndSizes: function ($) {
        ...
        //     this.Price = price;
        // }
        // var size = $(".ProductDetailInfoBlock-pricing-amount").children().text().trim();
        ...
        $(sizeElement).children().each(function (i, elem) {
            var temp = $(this).text().trim();
            //     if (temp != "Select Size") {
            //         sizesArray.push(temp)
            //     }
